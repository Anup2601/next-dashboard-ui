        ...
        <div className="flex flex-col lg:flex-row gap-4 ">
          ...
          <div className="bg-anupSky py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <h1 className="text-xl font-semibold">Sharita Kumari</h1>
              <p className="text-sm text-gray-500">
                This is a student enrolled in computer science engineering.
              </p>
          ...
          <div className="flex flex-1 gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%]  lg:w-[46%] ">
              ...
              />
              <div className="">
                <h1 className="font-semibold text-xl">16</h1>
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link
              className="p-3 rounded-md bg-anupYellowLight"
              href="/list/students"
            >
              Student&apos;s Lessons
            </Link>
            <Link
              className="p-3 rounded-md bg-anupSkyLight"
              href="/list/students"
            >
              Student&apos;s Teachers
            </Link>
            <Link className="p-3 rounded-md bg-pink-50" href="/list/students">
              Student&apos;s Exams
            </Link>
            <Link
              className="p-3 rounded-md bg-anupSkyLight"
            ...
            <Link
              className="p-3 rounded-md bg-anupPurpleLight"
              href="/list/students"
            >
              Student&apos;s Results
            </Link>
